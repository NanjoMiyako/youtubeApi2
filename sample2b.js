...
$(function() {
	...
	$('#play').click(function() {
		...
		var startSeconds = document.getElementById("saiseiKaisiJikoku").value;
		
		var playBackRate = document.getElementById("saiseiSokudo").value;
		if(isNaN(playBackRate)){
			playBackRate = 1.0;
		}else{
			playBackRate = parseFloat(playBackRate, 10);
